    ...
    converse.plugins.add("screencast", {
        ...
        'initialize': function () {
			...
			_converse.api.listen.on('connected', async function() {
				...
				//const http_upload = await _converse.api.disco.supports(converse.env.Strophe.NS.HTTPUPLOAD, domain);
	            //console.debug("screencast - connected - http_upload supported", http_upload, domain);
